<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="text-2xl font-black tracking-tight text-[var(--arena-blue)]">Moj nalog</h2>
    ...
    <div class="py-10">
        <div class="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
            <div class="space-y-6">
                <div class="rounded-[2rem] bg-[linear-gradient(145deg,rgba(13,59,102,0.96),rgba(215,38,61,0.82))] p-6 text-white shadow-sm">
                    <p class="text-sm uppercase tracking-[0.3em] text-blue-100">Moj profil</p>
                    ...
                    <div class="mt-6">
                        <a href="{{ route('sports.index') }}" class="inline-flex rounded-full bg-white px-5 py-3 text-sm font-bold uppercase tracking-[0.18em] text-[var(--arena-blue)]">Nova rezervacija</a>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-200">
                ...
                <h3 class="text-lg font-bold text-[var(--arena-blue)]">Istorija zahteva</h3>
                <div class="mt-5 space-y-4">
                    @forelse ($reservations as $reservation)
                        <div class="rounded-2xl border border-slate-200 p-4">
                            <div class="flex flex-wrap items-center justify-between gap-3">
                                <div>
                                    <p class="font-semibold text-[var(--arena-blue)]">{{ $reservation->court->name }}</p>
